...
public class SendFrame extends GUI {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(mailProgress, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        UpdateComs uc = new UpdateComs();
        uc.setSentL(sentL);
        uc.setLeftL(leftL);
        uc.setStartL(startL);
        uc.setFinishL(finishL);
        uc.setStartBtn(startBtn);
        uc.setProgressB(mailProgress);
        uc.setAvgL(avgL);
        uc.setStatusL(statusL);
